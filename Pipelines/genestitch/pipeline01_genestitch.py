...
def run_pipeline(args):
    ...
    outputs.append([all_df_vars_AF,"AF_ddg_variants.csv","AF_ddg_variants.png","variants AF","gene_no",False])
    outputs.append([all_df_backs_AF,"AF_ddg_background.csv","AF_ddg_background.png","background AF","pdb_rid",False])
    outputs.append([all_df_backs_AF,"AF_ddg_background.csv","AF_ddg_background_gene.png","background AF gene","gene_no",True])
