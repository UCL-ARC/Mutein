...
class BatchMaker:
    def __init__(self,script_file, yaml_file):                
        self.batches = []        
        self.batches.append("### SCRIPT AUTOMATICALLY GENERATED BY MUTEIN PIPELINE (UCL-ARC 2022) ###")
        ...
        self.batches.append('echo "~~~~~~~~~~~~~~~~~~ Call python script ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"')

    def addBatch(self,dataset,gene,pdb):
        #python ${script} $install_dir $PWD ${config} $run notch NOTCH1 1pb5
        line = 'python ${script} $install_dir $PWD ${config} $run ' + dataset + " " + gene + " " + pdb        
