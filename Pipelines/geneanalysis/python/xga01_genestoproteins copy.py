...
def run_pipeline(args):
    ...
    for gene in genes_list:
        ...
        if len(accession) > 1:
            ...
            bm2.printBatchScript(
                gene_path.gene_outputs + "/ppl_" + dataset + "_" + gene + "_stitch.sh",
                "",
            )
            batches_stitch.append(
                bm2.printBatchScript(
    ...
    bmAll.printBatches(
        gene_path.pipeline_path + "/ppl_" + dataset + "_all.sh",
        batches,
        gene_path.pipeline_path,
    )
    ...
    bmAll_stitch.printBatches(
        gene_path.pipeline_path + "/ppl_" + dataset + "_all_stitch.sh",
        batches_stitch,
        gene_path.pipeline_path,
    )
